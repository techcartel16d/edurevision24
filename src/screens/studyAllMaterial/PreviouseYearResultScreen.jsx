...
const PreviouseYearResultScreen = () => {
    ...
    const fetchUserResult = useCallback(async () => {
        try {
            setLoading(true);
            const res = await dispatch(getPreviouseYearPaperRankSlice(data?.id)).unwrap();
            ...
            if (res.status_code == 200) {
                ...
                setTestdetails(res.data.previous_year_exam_detail)
...
export default PreviouseYearResultScreen
