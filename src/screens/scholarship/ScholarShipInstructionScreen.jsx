...
const ScholarShipInstructionScreen = ({ route }) => {
    const store = new MMKV()
    const { schorData, scholarData } = route.params
    console.log("previouseExamId", schorData)
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={[styles.instructionContainer, { backgroundColor: colors.cardBg, }]}>
                    ...
                    <CustomeText color={colors.textClr} fontSize={13}>
                        1. The clock will be set at the server. The countdown timer at the top right corner of screen will display the remaining time available for you to complete the examination. When the timer reaches zaro, the examination will end by itself. You need not terminate the examination or submit your paper.
                    </CustomeText>
                    <CustomeText color={colors.textClr} fontSize={13}>
                    ...
                    <CustomeText color={colors.textClr} fontSize={13}>
                        Step 1: You have not visited the question yet.
                    </CustomeText>

                    <CustomeText color={colors.textClr} fontSize={13}>
                        Step 2: You have not answered the question.
                    </CustomeText>

                    <CustomeText color={colors.textClr} fontSize={13}>
                        Step 3: You have answered the question.
                    </CustomeText>

                    <CustomeText color={colors.textClr} fontSize={13}>
                        Step 4: You have NOT answered the question, but have marked the question for review.
                    </CustomeText>

                    <CustomeText color={colors.textClr} fontSize={13}>
                        Step 5: You have answered the question, but marked it for review.
                    </CustomeText>
                    ...
                    <CustomeText color={colors.textClr} style={{ fontWeight: 'bold', }} fontSize={13}>
                    ...
                    <CustomeText color={colors.textClr} fontSize={13}>
                        4. You will be awarded 2 mark for each corect answer and 0.5 will be deducted for each wrong answer
                    </CustomeText>
                    <CustomeText color={colors.textClr} fontSize={13}>
            ...
            <View style={{ padding: screenWidth * 4, width: '100%', gap: screenWidth * 2 }}>
                <TouchableOpacity disabled={!isChecked} onPress={() => {
                    replace("ScholarShipTestStartScreen", { schorData, scholarData })
                }} style={{ backgroundColor: isChecked ? colors.lightBlue : "#ccc", padding: screenWidth * 2, borderRadius: screenWidth * 2, alignItems: 'center', justifyContent: 'center' }}>
...
export default ScholarShipInstructionScreen
