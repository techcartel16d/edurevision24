...
import { fetchUserTestSeriesRankSlice, getPreviouseYearPaperRankSlice, getRankScholarShipSlice } from '../../redux/userSlice'

const ScholarShipResultScreen = () => {
    const dispatch = useDispatch()
    const route = useRoute()
    const { theme } = useTheme()
    const { colors } = theme
    const { data,schorData } = route.params
    console.log("data =====>", data)
    console.log("scholarData =====>", schorData)
    // return
    ...
    const fetchUserResult = useCallback(async () => {
        try {
            ...
            if (res.status_code == 200) {
                ...
                console.log("result data fetch now", res.data.my_detail)
                ...
                setTestdetails(res.data.scholarship_test_detail)
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
            ...
            <View style={[styles.resultHeader]}>
                <TouchableOpacity onPress={() => goBack("ScolarShipSignleVideoScreen", {scholarData:schorData})}>
                                            ...
                                            >
                                                  {resultData?.my_detail?.correct || '- -'}
                                                    ...
                                                    : '- -'} */}
                                                            ...
                                                            {
                                                                ((testDetails?.marks / testDetails?.total_question).toFixed(2)) * myDetails?.correct || '0'
                                                            }
                                                        </CustomeText>
                                ...
                                <>
                                    ...
                                    <FlatList
                                        ...
                                        renderItem={({ item, index }) => {
                                            ...
                                            let Marks = parseFloat(item.marks).toFixed(2)
                                            console.log("print marks==>", Marks)
                                                    ...
                                                    <View style={{
                                                        ...
                                                        <View style={{
                                                            ...
                                                            <View style={{
                                                                ...
                                                                <CustomeText variant='h5' style={{ fontWeight: "bold" }} color={colors.lightBlue}>{Marks}</CustomeText>
...
export default ScholarShipResultScreen
