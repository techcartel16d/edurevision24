...
import { fetchUserTestSeriesRankSlice } from '../../redux/userSlice'
...
const ResultScreen = () => {
    ...
    const { colors } = theme
    const { categoryId, testId, data, } = route.params
    ...
    const fetchUserResult = useCallback(async () => {
        try {
            setLoading(true);
            const res = await dispatch(fetchUserTestSeriesRankSlice(myTestId)).unwrap();
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
            ...
            {/* <View style={[styles.resultHeader]}>
                <TouchableOpacity onPress={() => replace("QuizePackageTestSeriesScreen", { categoryId, testId })}>
                            ...
                            isSelected === 'result' ? (
                                <ScrollView contentContainerStyle={{
                                    ...
                                    <View style={[styles.resultInfo, { backgroundColor: colors.headerBg }]}>
                                        ...
                                        <View>
                                            <CustomeText variant='h7' color={colors.textClr}> {`${testDetails?.total_no_of_question || '--'} Questions | ${testDetails?.total_marks || '0'} Marks | ${testDetails?.time || '0'} Minutes`}
                                            </CustomeText>
                                        </View>
                                    </View>
                                        ...
                                        <View style={[styles.resultBordTop, { backgroundColor: colors.cardBg, borderWidth: 0.5, borderColor: colors.borderClr }]}>
                                            <View style={{
                                                ...
                                                <View style={{
                                                    ...
                                                    <CustomeText variant='h5' fontFamily='Poppins-Bold' color={colors.textClr} style={{ textAlign: 'center', }}>
                                                        {testDetails?.total_no_of_question || '--'}
                                                    </CustomeText>
                                                </View>
                                                <View style={{
                                                    flex: 1,
                                            ...
                                            >
                                                  {resultData?.my_detail?.correct || '- -'}
                                                        ...
                                                        >
                                                            {/* {resultData?.my_detail?.correct !== undefined
                                                    ? (resultData.my_detail.correct < 10 ? `0${resultData.my_detail.correct}` : resultData.my_detail.correct)
                                                    : '- -'} */}


                                                            {
                                                                ((testDetails?.total_marks / testDetails?.total_no_of_question).toFixed(2)) * myDetails?.correct || '0'
                                                            }
                                                        </CustomeText>
                                            ...
                                            <View style={[styles.leaderBox, { backgroundColor: colors.cardBg }]} key={index}>
                                                <View style={{
                                                    ...
                                                    <View style={{
                                                        ...
                                                        <CustomeText fontFamily='Poppins-SemiBold' variant='h6' color={colors.textClr}>{item.user_name}</CustomeText>
                                                        <View style={{

                                                            alignItems: 'center',
                                                            justifyContent: 'space-between'
                                                        }}>
                                                            <CustomeText fontFamily='Poppins-Ragular' variant='h7' color={colors.textClr}>Marks</CustomeText>
                                                            <CustomeText variant='h5' style={{ fontWeight: "bold" }} color={colors.lightBlue}>{item.marks}</CustomeText>
                                                ...
                                                <View style={{
                                                    ...
                                                    <CustomeText fontSize={10} color='white'>{item.rank}</CustomeText>
                                                </View>
                                            </View>
                                        )}
